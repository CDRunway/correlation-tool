...
// ─── ASSET REGISTRY ───────────────────────────────────────────────────────────
const BASE_ASSETS = [
  { ticker:"IB1T.L",  label:"IB1T",    group:"Bitcoin",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"BTC-USD", label:"BTC/USD", group:"Bitcoin",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"LQQS.L",  label:"LQQS",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"DAGB.L",  label:"DAGB",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"IUIT.L",  label:"IUIT",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"IUCD.L",  label:"IUCD",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"IITU.L",  label:"IITU",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"SEMI.L",  label:"SEMI",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"RBOT.L",  label:"RBOT",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"ARKK",    label:"ARKK",    group:"Tech",       benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"SOIL.L",  label:"SOIL",    group:"Commodities",benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"SBRT.L",  label:"SBRT",    group:"Commodities",benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"REMX.L",  label:"REMX",    group:"Commodities",benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"BRNT.L",  label:"BRNT",    group:"Commodities",benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"CL=F",    label:"WTI",     group:"Commodities",benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"^GSPC",   label:"S&P500",  group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"^IXIC",   label:"NASDAQ",  group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"^FTSE",   label:"FTSE",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"CSPX.L",  label:"CSPX",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"SPYL.L",  label:"SPYL",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"EQQQ.L",  label:"EQQQ",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"EQGB.L",  label:"EQGB",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"ISF.L",   label:"ISF",     group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"VUKE.L",  label:"VUKE",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"ISPY.L",  label:"ISPY",    group:"Indices",    benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"NVDA",    label:"NVIDIA",  group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"TSLA",    label:"Tesla",   group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"AAPL",    label:"Apple",   group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"JPM",     label:"JPM",     group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"BAC",     label:"BAC",     group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"COIN",    label:"COIN",    group:"Stocks",     benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"EIMI.L",  label:"EIMI",    group:"EM",         benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"EMIM.L",  label:"EMIM",    group:"EM",         benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"EMGU.L",  label:"EMGU",    group:"EM",         benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"AEMU.L",  label:"AEMU",    group:"EM",         benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"REGB.L",  label:"REGB",    group:"EM",         benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"JEDG.L",  label:"JEDG",    group:"Thematic",   benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"IUVF.L",  label:"IUVF",    group:"Thematic",   benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"DXJ.L",   label:"DXJ",     group:"Thematic",   benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
  { ticker:"SUES.L",  label:"SUES",    group:"Thematic",   benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"] },
];
...
function AddAssetForm({customAssets,setCustomAssets,matrixAssets,setMatrixAssets,onClose}){
  ...
  const add=()=>{
    ...
    const a={ticker:ticker.trim()||lbl,label:lbl,group,benchmarkIdxs:["S&P500","NASDAQ","FTSE","DJIA","DAX","CAC","STOXX","Nikkei","HSI","SSE","ASX","Sensex","Bovespa","TSX"],custom:true};
